...
git@github.com:AdamImpinger/CLES131-module3-redlining.git
...
#was intially fill, would cover ndvi data
  ...
  geom_spatraster(data=ndvi4birmplot)+
    scale_fill_gradient2(low = "#fc8d59",
                       ...
                       high = "#91cf60",
                       na.value = "transparent")+
    geom_sf(data=birm.sf, aes(color=grade), fill= NA, linewidth=0.75) +
    coord_sf(xlim = c(-86.95, -86.60), ylim =c(33.4, 33.70))+
      scale_color_brewer(palette="Set1",
                     direction = -1)+
  ggplot()+
  geom_spatraster(data=ndvi4indyplot)+
    scale_fill_gradient2(low = "#fc8d59",
                       ...
                       high = "#91cf60",
                       na.value = "transparent")+
    geom_sf(data=indy.sf, aes(color=grade), fill= NA, linewidth=0.75) +
    coord_sf(xlim = c(-86.3887, -85.9385), ylim =c(39.67222222,39.95))+
      scale_color_brewer(palette="Set1",
                     direction = -1)+
  ggplot()+
  geom_spatraster(data=ndvi4minnplot)+
    scale_fill_gradient2(low = "#fc8d59",
                       ...
                       high = "#91cf60",
                       na.value = "transparent")+
    geom_sf(data=minn.sf, aes(color=grade), fill= NA, linewidth=0.75) +
  ...
  geom_spatraster(data=ndvi4phoeplot)+
    scale_fill_gradient2(low = "#fc8d59",
                       ...
                       high = "#91cf60",
                       na.value = "transparent")+
    geom_sf(data=phoe.sf, aes(color=grade), fill= NA, linewidth=0.75) +
